...
export default async function Page(){
 ...
 const {data:items}=await s.from('real_estate_glossary').select('id,term,full_name,category,language,definition,portugal_usage,caution,related_terms,source_url,verified_at').eq('status','published').order('term')
